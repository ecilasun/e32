...
# This one counts as a switch in hardware, unused for now, can use to detect card presence/insert/eject
...
#set_output_delay 2 -clock [get_clocks wallclock] [get_ports leds[*]]
